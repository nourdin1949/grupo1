    ...
    <form class="col s12" action="insertarDatos.php" method="POST">
      ...
      <div class="row">
        ...
        <p>
          ...
          <textarea name="alumno" id="alumno" class="materialize-textarea" placeholder="Nombre hijo/a"></textarea>
          del curso<textarea name="curso" id="curso" class="materialize-textarea" placeholder="Curso"></textarea>
          ha tenido lugar el dia<br> <input type="date" class="datepicker" name="fecha_suceso" id="fecha_suceso" />
          <br>
        ...
        Otros<textarea name="motivos[]"value="5" id="5" class="materialize-textarea" placeholder="Otros motivos"></textarea>
        </p>
        <!-- Fecha del día que se llama al padre/madre/tutor legal -->
        Se llama a la familia el día <br>
        <div class="input-field col s6">
          <input type="date" class="datepicker" id="fecha_llamada" name="fecha_llamada" />
        </div>
        <div class="input-field col s6">
          <input type="time" class="datepicker" name="horaCita" id="horaCita" placeholder="Hora" />
        </div>
        <br><br><br><br>
        ...
        <br>
        Navalmoral de la Mata, a <input type="date" class="datepicker" name="fecha_rellenar" id="fecha_rellenar" />
        <br><br><br><br>
        Fdo. Raúl Garrido Jiménez <br>
        Jefe de Estudios
        <br><br>
        <!-- Firma del profesor que pone el parte y la asignatura o el modulo que imparte -->
        Fdo. Profesor<textarea name="profesor" id="profesor" class="materialize-textarea" placeholder="Firma"></textarea><br>
       <br>
