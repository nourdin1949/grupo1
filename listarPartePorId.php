    ...
    <form class="col s12" action="" method="POST">
      ...
      <div class="row">
        ...
        <p>
          ...
          <input type="text"name="alumno" id="alumno" value="<?php echo $arrayAlumno[0]['nombre'];?>" class="materialize-textarea" placeholder="Nombre hijo/a">
          del curso<input type="text" name="curso" id="curso" value="<?php echo $arrayAlumno[0]['curso'];?>" class="materialize-textarea" placeholder="Curso">
          ha tenido lugar el dia<br> <input type="date" value="<?php echo $arrayParte[0]['fecha_suceso'];?>"class="datepicker" name="fecha_suceso" id="fecha_suceso" />
          <br>
        ...
        Otros<input name="motivos[]" type="text" value=" <?php echo $otros?>" id="4" class="materialize-textarea" placeholder="Otros motivos">     
        
        Se llama a la familia el día<br><div class="input-field col s6">
        ...
        <br>
        <input type="text" name="personaCitada" value="<?php echo $arrayParte[0]['personaCitada'];?>" id="personaCitada" class="materialize-textarea" placeholder="Contacto"><br><br>
        Para cualquier aclaración, póngase en contacto con el Centro.
        <br>
        Navalmoral de la Mata, a <input type="date" value="<?php echo $arrayParte[0]['fecha_rellenar'];?>" class="datepicker" name="fecha_rellenar" id="fecha_rellenar" />
        <br><br><br><br>
        Fdo. Raúl Garrido Jiménez <br>
        Jefe de Estudios
        <br><br>
        
        Fdo. Profesor<input type="text" name="profesor"   value="<?php echo $arrayParte[0]['profesor'];?>" id="profesor" class="materialize-textarea" placeholder="Firma"><br>
       <br>
